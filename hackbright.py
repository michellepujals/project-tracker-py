...
def add_a_project(project_title, description, max_grade):
    """Add a new project, including the title, description, and max grade."""
    ...
    print(f"Successfully added project: {project_title}.")
...
def handle_input():
    ...
    while command != "quit":
        ...
        if command == "student":
            ...
            add_a_project(project_title, description, max_grade)
